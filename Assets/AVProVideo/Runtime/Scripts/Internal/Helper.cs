...
namespace RenderHeads.Media.AVProVideo
{
	...
	{
		public const string AVProVideoVersion = "3.0.4";
		public sealed class ExpectedPluginVersion
		{
			public const string Windows      = "3.0.4";
			public const string WinRT        = "3.0.4";
			public const string Android      = "3.0.4";
			public const string Apple        = "3.0.4";
		}
